...
window.DATA = (() => {
  ...
  const fleet = {
    ...
    operators: [
      ...
      { id: 'OP1002', name: 'Eleanor Whitfield', machine: 'EXC007', type: '336 excavator', idle: [18, 17, 19, 18, 17], fuel: 0.58 },
      { id: 'OP1003', name: 'Oliver Bennett', machine: 'WL014', type: '950 wheel loader', idle: [29, 27, 30, 28, 26], fuel: 0.44 },
    ],
    incidents: [1, 0, 2, 1, 4],
    queue: [
