...
(() => {
  ...
  const OPERATORS = [
    ...
    { id: 'OP1002', name: 'Eleanor Whitfield', level: 'Expert', licence: 'F1 Licence' },
    { id: 'OP1003', name: 'Oliver Bennett', level: 'Beginner', licence: 'F3 Licence' },
  ];
  ...
  function showLogin(step = 'who') {
    ...
    const draw = () => { o.innerHTML = `<div class="login-card">${side}${views[step]()}</div><div class="login-designer">Designed by <b>Aayush Visuals</b></div>`; icons(); };
