...
window.Machine3D = (() => {
  ...
  function build() {
    ...
    /* boom: boom, stick, cylinders and hoses are the faulty system in this demo (boom cylinder leaking) */
    PART = 'hydraulics'; FAULT = true;
    const BZ = -0.25;
