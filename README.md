...
- Works on phones:
  - **Top bar**: black, edge to edge, with the white Cat logo, EXC001, three plain icons (Parked, Telemetry, night mode) and a compact SOS. The browser bar turns black to match.
